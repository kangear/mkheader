...
table_entry_t type_name[] = {
    ...
    { IH_TYPE_FIRMWARE,   "bootloader",       "Bootloader",           },
...
print_header (image_header_t *hdr)
{
      ...
      if (0 == strcmp("BOOT", hdr->ih_name))
    	  type = "Bootloader";
      else if (0 == strcmp("KERN", hdr->ih_name))
    	  type = "Kernel";
      else if (0 == strcmp("ROOT", hdr->ih_name))
    	  type = "rootfs";
      printf ("Image Type:   %.*s\n", IH_NMLEN, type);
